...
function check_update()
    ...
    -- Например:
    -- local response = httpGet('URL_ДЛЯ_ПРОВЕРКИ_ВЕРСИИ')
    
    -- Для примера просто откроем ссылку
...
-- При нажатии на кнопку вызываем функцию check_update
if imgui.SmallButton(u8'Скачать обновление') then
    check_update()  -- Перенаправляем на функцию
end
