...
print('[Goss Helper] (переписан автор MTG) Скрипт запущен. Версия: ' .. thisScript().version)
-------------------------------------------- JSON SETTINGS ---------------------------------------------
...
local default_settings = {
	...
	player_info = {
		...
		fraction_tag = 'Поставте тэг',
		fraction_rank = 'Замените в Goss Helper/Settings.json',
...
local input_fraction_tag = imgui.new.char[256](u8(settings.player_info.fraction_rank))
